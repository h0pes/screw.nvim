...
-- 1. Edit line 319 to replace 'YOUR_SECURE_PASSWORD_HERE' with a secure password
-- 2. Optionally change the username 'screw_user' if desired
--
-- Usage:
...
CREATE ROLE screw_user WITH LOGIN PASSWORD 'YOUR_SECURE_PASSWORD_HERE';
...
\echo 'User: screw_user (password: YOUR_SECURE_PASSWORD_HERE)'
...
\echo 'export SCREW_DB_URL="postgresql://screw_user:YOUR_SECURE_PASSWORD_HERE@localhost:5432/screw_notes"'
\echo 'export SCREW_API_URL="http://localhost:3000/api"'
\echo 'export SCREW_USER_EMAIL="your-email@company.com"'
\echo ''
\echo 'Test connection:'
\echo 'psql postgresql://screw_user:YOUR_SECURE_PASSWORD_HERE@localhost:5432/screw_notes -c "SELECT COUNT(*) FROM projects;"'
\echo ''
