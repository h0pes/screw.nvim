  ...
  if subcommand == "note" then
    ...
    elseif action == "view" then
      ...
      elseif scope == "all" then
        ...
        vim.api.nvim_err_writeln("Invalid scope: " .. scope .. ". Use: line, file, or all")
      end
    else
      vim.api.nvim_err_writeln("Unknown note action: " .. (action or ""))
      vim.api.nvim_err_writeln("Available note actions: add, edit, delete [line|file], reply, view [line|file|all]")
    end
