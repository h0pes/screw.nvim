...
describe("screw.notes.manager", function()
  ...
  before_each(function()
    ...
    package.loaded["screw.notes.storage"] = {
      ...
      get_all_notes = function() return {mock_note} end,
      get_note = function() return mock_note end,
      delete_note = function() return true end,
      get_notes_for_file = function() return {mock_note} end,
      get_notes_for_line = function() return {mock_note} end,
    }
  end)
